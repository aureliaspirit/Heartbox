const CACHE_NAME="heartbox-pwa-v1-9-2";
const ASSETS=["./","./index.html","./style.css?v=1.9.2","./app.js?v=1.9.2","./manifest.json?v=1.9.2","./icons/icon-192.png","./icons/icon-512.png"];
