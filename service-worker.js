const CACHE_NAME="heartbox-pwa-v1-8-7";
const ASSETS=["./","./index.html","./style.css?v=1.8.7","./app.js?v=1.8.7","./manifest.json?v=1.8.7","./icons/icon-192.png","./icons/icon-512.png"];
