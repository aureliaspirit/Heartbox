const CACHE_NAME="heartbox-pwa-v1-8-4";
const ASSETS=["./","./index.html","./style.css?v=1.8.3","./app.js?v=1.8.3","./manifest.json?v=1.8.3","./icons/icon-192.png","./icons/icon-512.png"];
