const CACHE_NAME="heartbox-pwa-v1-9-0";
const ASSETS=["./","./index.html","./style.css?v=1.9.0","./app.js?v=1.9.0","./manifest.json?v=1.9.0","./icons/icon-192.png","./icons/icon-512.png"];
